...
object Dependencies {
  ...
  object V {
    ...
    val decline = "2.4.1"
    val http4s = "0.23.16"  // Add the HTTP4S version
  }
  ...
  object Libraries {
    ...
    // HTTP4S libraries for API support
    ...
    // Doobie and Postgres for database interaction
    ...
    // Requests for HTTP requests (if still needed)
