...
import com.my.shared_data.schema.Updates.DataUpdateOnChain

package object lib {

  object syntax {

    implicit class ListSignedUpdateOps(lst: List[Signed[DataUpdateOnChain]]) {
      def toSortedSet: SortedSet[Signed[DataUpdateOnChain]] = SortedSet(lst: _*)
    }
